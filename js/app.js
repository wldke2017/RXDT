  ...
  app.innerHTML = `
    ...
    <nav class="mobile-nav">
      <div class="mobile-nav-items">
        ...
        <div class="mobile-nav-item" data-page="follow" onclick="navigateTo('follow')">
